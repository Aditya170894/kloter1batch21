...
$datas = query("SELECT * FROM `school_tb`");
...
<body style="background-color:#000000">
    <div class="container">
      <div class="d-flex flex-row my-5 justify-content-between">
        <h3>School Data</h3>
        <button type="button" data-bs-toggle="modal" data-bs-target="#modalPost" class="btn btn-warning btn-post">Add School</button>
      </div>
      <?php $i = 1; ?>
      ...
      <div class="card mb-3 mt-3 p-2 d-flex" style="background-color: #292929;">
        <div class="d-flex flex-row card-list">
          <div class="col-md-4 image-author text-center">
            <img src=<?= $data['logo_school']; ?> alt="...">
            <div><?=$data["name_school"]?></div>
            <div><?=$data["status_school"]?></div>
      ...
      <form class="modal-content" method="post">
        ...
        <div class="modal-body">
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="NPSN" aria-label="Username" aria-describedby="basic-addon1" name="NPSN" id="NPSN">
          </div>
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="Nama Sekolah" aria-label="Username" aria-describedby="basic-addon1" name="name_school" id="name_school">
          </div>
        </div>
        <div class="modal-body">
          <div class="input-group mb-3">
        ...
        <div class="modal-body">
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="Logo Sekolah" aria-label="Username" aria-describedby="basic-addon1" name="logo_school" id="logo_school">
          </div>
        </div>
        <div class="modal-body">
          <div class="input-group mb-3">
